        ...
        <div className="p-6">
          <div className="space-y-3 overflow-y-auto max-h-100 pr-2 custom-scrollbar">
            {lines.map((line, index) => (
              ...
              >
                <p className="text-gray-300 font-mono text-sm whitespace-pre-wrap pr-10 mr-5">
                  {line}
                </p>
                <button className="absolute top-1 right-1 text-gray-500 group-hover:text-purple-400 transition-colors">
                  {copiedIndex === index ? (
          ...
          <p className="text-[13px] text-gray-500 mt-4 italic">
